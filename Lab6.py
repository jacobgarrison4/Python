...
def readTree (inputFile):
	...
	The result tree is a dictionary, whose keys are the indexes of nodes and the values of the dictionary
	are pairs of the value of nodes and the list of their children. For example tree[1] = (15, [2, 4])
	means that node 1 has value 15 and it has two children with indexes of 2 and 4.
