...
def plot_clusters(eq_clusters, eq_dict):
    ...
    """
    global eq_turtle
    datadict = read_file(eq_dict)
    quakeCentroids = create_centroids(6, datadict)
    clusters = create_clusters(6, quakeCentroids, datadict, 7)

    colorlist = ["green", "blue", "red", "cyan", "orange", "yellow"]
    
    for clusterIndex in range(6):
        eq_turtle.color(colorlist[clusterIndex])
        for key in clusters[clusterIndex]:
            lon = datadict[key][0]
            lat = datadict[key][1]
            eq_turtle.goto(lon*size_x, lat*size_y)
            eq_turtle.dot()
        eq_win.exitonclick()
...
def plot_depths(eq_dict):
    ...
    print("Replace this line with code to plot depths")
...
def analyze_depths(eq_dict):
    ...
    """
    # FIXME: Your code replaces the next line
    print("Replace this line with code to analyze depths")
...
def analyze_magnitudes(eq_dict):
    ...
    """
    # FIXME: Your code replaces the next line
    print("Replace this line with code to analyze magnitudes")
...
def analyze_clusters(eq_clusters, eq_dict):
    ...
    """
    # FIXME: Your code replaces the next line
    print("Replace this line with code to analyze clusters")
